                ...
                <div class="col-lg-8">
                    <div class="rts-blog-list">
                        ...
                        <div class="single-post">
                            <a href="#">
                                <img src="{{asset ('assets/images/blog/blog-list-1.png') }}" width="870" height="440" alt="">
                            </a>
                            <div class="single-post__meta">
                                <div class="author__date__cat">
                                    <div class="author"><i class="fa-regular fa-circle-user"></i> By <a href="#">Emran Hossen</a></div>
                                    <span class="date"><i class="fa-regular fa-clock"></i> 15 Jan, 2023</span>
                        ...
                        <div class="single-post">
                            <a href="#">
                                <img src="{{asset ('assets/images/blog/blog-list-2.png') }}" width="870" height="440" alt="">
                            </a>
                            <div class="single-post__meta">
                                <div class="author__date__cat">
                                    <div class="author"><i class="fa-regular fa-circle-user"></i> By <a href="#">Emran Hossen</a></div>
                        ...
                        <div class="single-post">
                            <a href="#">
                                <img src="{{asset ('assets/images/blog/blog-list-3.png') }}" width="870" height="440" alt="">
                            </a>
                            <div class="single-post__meta">
                                <div class="author__date__cat">
                                    <div class="author"><i class="fa-regular fa-circle-user"></i> By <a href="#">Emran Hossen</a></div>
