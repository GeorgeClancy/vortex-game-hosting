            ...
            <div class="banner-slider-active">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="rts-hosting-banner hosting__offer__bg" style="background-image: url({{asset ('assets/images/banner/offer__background.jpg') }});">
                            <div class="container">
                                <div class="row justify-content-md-center justify-content-lg-start">
                                    <div class="col-lg-4">
                                        <div class="banner-area">
                                            <div class="banner-area__content">
                                                <img src="{{asset ('assets/images/50__off.png') }}" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="rts-hosting-banner hosting__offer__bg" style="background-image: url({{asset ('assets/images/banner/offer__background-2.jpg') }});">
                            <div class="container">
                                <div class="row justify-content-md-center justify-content-lg-start">
                                    <div class="col-lg-6">
                                        <div class="banner-area style__two">
                                            <div class="banner-area__content">
                                                <img src="{{asset ('assets/images/50__off-2.png') }}" alt="">
