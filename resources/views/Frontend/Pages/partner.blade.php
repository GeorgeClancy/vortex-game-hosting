                ...
                <div class="col-lg-12">
                    <div class="banner-area">
                        <div class="rts-hosting-banner rts-hosting-banner__content pricing__banner">
                            <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Partner</span>
                            ...
                            <div class="feature mb-0" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                                <ul class="feature__list">
                                    <li class="feature__item">Up to 20% commissions</li>
                                    <li class="feature__item">Simple and secure access management</li>
                                </ul>
                            </div>
                        ...
                        <div class="rts-hosting-banner__image partner">
                            <img src="{{asset ('assets/images/banner/banner__partner__image.svg') }}" alt="">
                            <div class="shape__image">
                                <img src="{{asset ('assets/images/banner/banner__partner__image-sm1.svg') }}" alt="" class="shape__image--one">
                                <img src="{{asset ('assets/images/banner/banner__partner__image-sm2.svg') }}" alt="" class="shape__image--two">
                                <img src="{{asset ('assets/images/banner/banner__partner__image-sm3.svg') }}" alt="" class="shape__image--three left-right2">
                                <img src="{{asset ('assets/images/banner/banner__partner__image-sm4.svg') }}" alt="" class="shape__image--four show-hide">
                                <img src="{{asset ('assets/images/banner/banner__partner__image-sm5.svg') }}" alt="" class="shape__image--five left-right2">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="rts-feature-area partner section__padding">
        <div class="container">
            <div class="section-inner">
                <div class="row gy-40 align-items-center mb--120">
                    <div class="col-lg-4">
                        <div class="left-side-content">
                            <div class="rts-section">
                                <h2 class="rts-section__title mb-0" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Earn Recurring
                                    Commissions</h2>
                            </div>
                            <div class="feature mb-0" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                                <ul class="feature__list">
                                    <li class="feature__item">Powerful and Unique Tools for Your Email Inbox</li>
                                    <li class="feature__item">Get up to 20% commissions per sale.</li>
                                    <li class="feature__item">Earn recurring commissions when your clients
                                        renew their services.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="right-side-image">
                            <img src="{{asset ('assets/images/feature/dashboard.png') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="left-side-image">
                            <img src="{{asset ('assets/images/feature/dashboard2.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="right-side-content">
                            <div class="rts-section">
                                <h2 class="rts-section__title mb-0" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Manage All Clients in One Dashboard</h2>
                            </div>
                            <div class="feature mb-0" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                                <ul class="feature__list">
                                    <li class="feature__item">View all clients and their services in one dashboard.</li>
                                    <li class="feature__item">Save time with bulk management. (coming soon)</li>
                                    <li class="feature__item">Monitor performance via client reporting tools.
                                        (coming soon)</li>
                                    <li class="feature__item">Use our invoicing & billing system. (coming soon)</li>
                                </ul>
                            </div>
                        </div>
                    </div>
