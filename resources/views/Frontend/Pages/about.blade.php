...
@section('content')
    ...
    <!-- TEAM AREA -->
    <section class="rts-team-area pt--120 pb--120">
        <div class="container">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                                            <img src="{{asset ('assets/images/testimonials/author.png') }}" height="50" width="50" alt="">
                                        </div>
                                        <div class="author__meta">
                                            <h6>Rubel Hossen</h6>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                                            <img src="{{asset ('assets/images/testimonials/author-2.png') }}" height="50" width="50" alt="">
                                        </div>
                                        <div class="author__meta">
                                            <h6>Rubel Khan</h6>
                                            <span>Web Developer</span>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                                            <img src="{{asset ('assets/images/testimonials/author-3.png') }}" height="50" width="50" alt="">
                                        </div>
                                        <div class="author__meta">
                                            <h6>Samira Khan</h6>
                                            <span>Managing Director</span>
