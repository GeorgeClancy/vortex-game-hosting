...
@section('content')
    ...
    <!-- HOSTIE LATEST BLOG -->
    <section class="rts-blog-area blog-area-six inner pt--120">
        <div class="container">
            <div class="section-inner">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title animated fadeIn"><a href="#">Expanding Horizons: Announcing the
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title animated fadeIn"><a href="#">Introducing Edge Page Caching, Argo
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            <div class="image">
                                <img src="{{asset ('assets/images/blog/blog-12.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                    <span class="category">Web Hosting</span>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            <div class="image">
                                <img src="{{asset ('assets/images/blog/blog-13.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                    <span class="category">Cloud Hosting</span>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            <div class="image">
                                <img src="{{asset ('assets/images/blog/blog-14.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                    <span class="category">Web Hosting</span>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            <div class="image">
                                <img src="{{asset ('assets/images/blog/blog-15.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                    <span class="category">Cloud Hosting</span>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            <div class="image">
                                <img src="{{asset ('assets/images/blog/blog-16.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                    <span class="category">Web Hosting</span>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-wrapper">
                            <div class="image">
                                <img src="{{asset ('assets/images/blog/blog-17.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                    <span class="category">Cloud Hosting</span>
