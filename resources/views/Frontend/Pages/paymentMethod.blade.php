                ...
                <div class="col-lg-12">
                    <div class="banner-area">
                        <div class="rts-hosting-banner rts-hosting-banner__content pricing__banner">
                            <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Payment Method</span>
                            <h1 class="banner-title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                                Payment Methods
                            </h1>
                            <p class="slogan" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">You can purchase our services using a wide range of payment methods.</p>
                            <div class="hosting-action">
                                <a href="{{route('pricingPackage')}}" class="btn__two secondary__bg secondary__color">Start Now <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
    ...
    <section class="rts-payment-option section__padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-440 text-center">
                    <h2 class="rts-section__title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Payment Options</h2>
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">We accept a variety of credit and debit cards, e-wallets, and a wide range of cryptocurrencies.</p>
                </div>
            </div>
                ...
                <div class="row g-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="payment-method-wrapper">
                            <h3 class="heading-title">Credit and Debit Cards</h3>
                            <ul class="brand-area">
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/visa.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/master-card.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/discover.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/diners-club.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/maestro.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/american-express.png') }}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="payment-method-wrapper method-2">
                            <h3 class="heading-title">E-Wallets</h3>
                            <ul class="brand-area">
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/paypal.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/amazon.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/skrill.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/wise.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/ebay.png') }}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="payment-method-wrapper method-3">
                            <h3 class="heading-title">Credit and Debit Cards</h3>
                            <ul class="brand-area">
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/bitcoin.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/tron.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/ethereum.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset ('assets/images/payment/litecoin.png') }}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="rts-section text-center">
                        <h2 class="rts-section__title mb-0" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Payments FAQs</h2>
                    </div>
