            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-5">
                    <div class="rts-pricing-plan__tab plan__tab--shadow">
                        ...
                        <div class="discount">
                            <span class="line">
                                <img src="{{asset ('assets/images/pricing/offer__vactor.svg') }}" height="20" width="85" alt="">
                            </span>
                            <p>20% save</p>
                        </div>
                    </div>
                        ...
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>12.36</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow active">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>99.36</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>55.36</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>144.36</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow active">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>1000.36</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>448.36</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
