            ...
            <div class="row">
                <div class="banner-area">
                    ...
                    <div class="rts-hosting-banner__image faq">
                        <img src="{{asset ('assets/images/banner/faq/banner__faq__image.svg') }}" alt="">
                        <img class="shape one rotate-one" src="{{asset ('assets/images/banner/faq/banner__faq__image-sm1.svg') }}" alt="">
                        <img class="shape two rotate-two" src="{{asset ('assets/images/banner/faq/banner__faq__image-sm2.svg') }}" alt="">
                        <img class="shape three" src="{{asset ('assets/images/banner/faq/banner__faq__image-sm3.svg') }}" alt="">
                        <img class="shape four" src="{{asset ('assets/images/banner/faq/banner__faq__image-sm4.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
