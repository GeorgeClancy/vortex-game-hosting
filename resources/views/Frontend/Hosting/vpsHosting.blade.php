                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content">
                        ...
                        <div class="hosting-action">
                            ...
                            <a href="{{route('pricingPackage')}}" class="btn__white">Starting @ $10.00/mo</a>
                        </div>
                    </div>
            ...
            <div class="row align-items-center gy-30">
                ...
                <div class="col-lg-8 col-xl-7 col-md-12 d-md-flex justify-content-md-center">
                    <div class="performance-tab-content tab__content open" id="nginx">
                        <div class="image-one">
                            <img src="{{asset ('assets/images/feature/vps/vps-small.png') }}" alt="" height="545" width="307">
                        </div>
                        <div class="image-two">
                            <img src="{{asset ('assets/images/feature/vps/vps-big.png') }}" alt="" height="545" width="420">
                        </div>
                    </div>
                ...
                <div class="col-lg-6 d-md-flex justify-content-md-center">
                    <div class="hosting-feature-image">
                        <div class="hosting-feature-image__image">
                            <div class="img-one">
                                <img src="{{asset ('assets/images/feature/vps__feature__small.png') }}" height="400" alt="">
                            </div>
                            <div class="img-two">
                                <img src="{{asset ('assets/images/feature/vps__feature__big.png') }}" height="400" alt="">
                            </div>
                        </div>
                    </div>
                </div>
