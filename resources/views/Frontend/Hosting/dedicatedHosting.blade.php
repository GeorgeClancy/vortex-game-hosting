            ...
            <div class="row justify-content-sm-center">
                <div class="banner-area">
                    ...
                    <div class="rts-hosting-banner__image dedicated-banner__image">
                        <img src="{{asset ('assets/images/banner/banner__dedicated__image.svg') }}" alt="">
                        <img class="shape-image one" src="{{asset ('assets/images/banner/banner__dedicated__image-sm1.svg') }}" alt="">
                        <img class="shape-image two" src="{{asset ('assets/images/banner/banner__dedicated__image-sm2.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gy-30">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="dedicated-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/dedicated/1.svg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="dedicated-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/dedicated/2.svg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="dedicated-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/dedicated/3.svg') }}" alt="">
                        </div>
            ...
            <div class="row gy-30 justify-content-center">
                <div class="col-lg-6 col-xl-4 col-md-12">
                    <div class="dedicated-feature-section">
                        ...
                        <div class="single-feature">
                            <div class="icon">
                                <img src="{{asset ('assets/images/feature/dedicated/server.svg') }}" alt="">
                            </div>
                            <p>Use your server resources how you want without having to share.</p>
                        </div>
                        <div class="single-feature">
                            <div class="icon">
                                <img src="{{asset ('assets/images/feature/dedicated/ram.svg') }}" alt="">
                            </div>
                            <p>Use your server resources how you want without having to share.</p>
                        </div>
                        <div class="single-feature">
                            <div class="icon">
                                <img src="{{asset ('assets/images/feature/dedicated/support.svg') }}" alt="">
                            </div>
                            <p>Use your server resources how you want without having to share.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 offset-lg-1 col-xl-6 offset-xl-2 col-md-12">
                    <div class="dedicated-feature-image">
                        <img src="{{asset ('assets/images/feature/dedicated/image-1.png') }}" alt="" height="444" width="645">
                ...
                <div class="col-lg-6 col-md-12 mt--100">
                    <div class="dedicated-feature-image">
                        <img src="{{asset ('assets/images/feature/dedicated/image-2.png') }}" alt="" height="444" width="645">
                        <div class="featured-item">
                            <div class="icon">
                                <img src="{{asset ('assets/images/feature/dedicated/email.svg') }}" alt="">
                            </div>
                            <div class="content">
                                <h6>Hostie Mail</h6>
