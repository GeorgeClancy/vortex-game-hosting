...
@section('title', 'Reseller Hosting')
@section('content')
    <!-- HEADER AREA -->
                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content resell__banner">
                        ...
                        <div class="hosting-action" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                            <a href="{{route ('pricing')}}" class="btn__two secondary__bg secondary__color">View Plan <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="#" class="btn__white">Starting @ $10.00/mo</a>
                        </div>
                    </div>
                    <div class="rts-hosting-banner__image reseller-banner__image">
                        <img src="{{asset ('assets/images/banner/banner__resell__image.svg') }}" alt="">
                        <img class="shape-image one" src="{{asset ('assets/images/banner/banner__resell__image-sm1.svg') }}" alt="">
                        <img class="shape-image two" src="{{asset ('assets/images/banner/banner__resell__image-sm2.svg') }}" alt="">
                        <img class="shape-image three pulsing" src="{{asset ('assets/images/banner/banner__resell__image-sm3.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row g-30">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/cloud/billing.svg') }}" height="50" width="60" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/cloud/moneybag.svg') }}" height="50" width="60" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/cloud/cloud.svg') }}" height="50" width="60" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/cloud/speed-meter.svg') }}" height="50" width="60" alt="">
                        </div>
