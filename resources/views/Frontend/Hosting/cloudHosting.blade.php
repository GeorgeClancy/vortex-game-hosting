                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content cloud__banner">
                        ...
                        <div class="hosting-action">
                            <a href="{{route('pricing')}}" class="btn__two secondary__bg secondary__color">Buy VPS <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="{{('pricingPackage')}}" class="btn__white">Starting @ $10.00/mo</a>
                        </div>
                    </div>
                    <div class="rts-hosting-banner__image">
                        <img src="{{asset ('assets/images/banner/banner__cloud__image.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row g-30">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/cloud/2.svg') }}" height="50" width="60" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/cloud/ssl.svg') }}" height="50" width="60" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                    <div class="cloud-feature">
                        <div class="icon">
                            <img src="{{asset ('assets/images/feature/cloud/collaboration.svg') }}" height="50" width="60" alt="">
                        </div>
                    ...
                    <div class="row g-30 yearly">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                ...
                                <p class="card-plan__desc">Everything need to your website</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"><span>$</span><span rt-price>36.63</span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                ...
                                <p class="card-plan__desc">Level-up more power features</p>
                                <div class="card-plan__offer">
                                    <span class="past-price"> <span rt-currency-symbol>$</span> <span rt-price>191.63</span></span></span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>76.63</span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    <span rt-currency-symbol>$</span> <span rt-price>151.99</span> /year when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <h5 class="card-plan__price">
                                    <sup rt-currency-symbol>$</sup> <span rt-price>269.63</span> <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="#">add to cart</a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-5 col-xl-6">
                    <div class="support-feature-image">
                        <img src="{{asset ('assets/images/feature/support__feature.png') }}" width="645" height="477" alt="">
                    </div>
                </div>
                    ...
                    <div class="support-feature__content">
                        ...
                        <div class="priority-content" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                            <div class="single-priority">
                                <div class="icon">
                                    <img src="{{asset ('assets/images/feature/cloud/p-1.svg') }}" alt="">
                                </div>
                                <div class="content">
                            ...
                            <div class="single-priority">
                                <div class="icon">
                                    <img src="{{asset ('assets/images/feature/cloud/speed-meter.svg') }}" alt="">
                                </div>
                                <div class="content">
                                    <h5>Advanced expertise</h5>
                                    <p class="mb-0">By our best agents</p>
                            ...
                            <div class="single-priority">
                                <div class="icon">
                                    <img src="{{asset ('assets/images/feature/cloud/p-2.svg') }}" alt="">
                                </div>
                                <div class="content">
                            ...
                            <div class="single-priority">
                                <div class="icon">
                                    <img src="{{asset ('assets/images/feature/cloud/rated.svg') }}" alt="">
                                </div>
                                <div class="content">
                                    <h5>Highly rated</h5>
                                    <p class="mb-0">By our best agents</p>
