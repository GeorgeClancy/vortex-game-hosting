...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="banner-area">
                        <div class="rts-hosting-banner rts-hosting-banner__content">
                            <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Starting at $2.59/mo</span>
                            <h1 class="banner-title" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                                Shared Website
                                Hosting
                            </h1>
                            <p class="slogan" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">Everything you need to launch a website.</p>
                        ...
                        <div class="rts-hosting-banner__image">
                            ...
                            <img class="shape-image one right-left" src="{{asset ('assets/images/banner/shared/shared__hosting-sm1.svg') }}" alt="">
                            <img class="shape-image two pulsing" src="{{asset ('assets/images/banner/shared/shared__hosting-sm2.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-490 text-center">
                    ...
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Globally incubate next-generation e-services via state <br> of the art technology.
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="rts-section section-style-two">
                    <div class="rts-section__two">
                        <h2 class="title mb-0" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Why <br>
                            Chooses Hostie</h2>
                    </div>
                    <div class="rts-section-description w-400">
                        <p class="description" data-sal="slide-left" data-sal-delay="200" data-sal-duration="800">
                ...
                <div class="col-lg-6 col-md-10">
                    <div class="hosting-feature-image">
                        <div class="hosting-feature-image__image">
                            <img src="{{asset ('assets/images/feature/feature__image.png') }}" height="428" width="645" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-10">
                    <div class="hosting-feature">
                        <h3 class="hosting-feature__title font-40" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Shared Hosting
                        ...
                        <div class="feature">
                            <ul class="feature__list" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
    ...
    <div class="rts-client-feedback bg-white section__padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-490 text-center">
    ...
    <!-- HOSTIE BRAND AREA -->
    <div class="rts-brand shared-page-bg ">
        <div class="container">
            <div class="row">
                <div class="rts-brand__wrapper">
                    <div class="rts-brand__wrapper--text">
                        ...
                        <div class="rts-brand__wrapper--text-review" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                            <div class="review">
                                <div class="star">Excellent <img src="{{asset ('assets/images/brand/review-star.svg') }}" alt=""></div>
                            </div>
