                ...
                <div class="col-lg-6">
                    <div class="rts-hero__content w-550">
                        ...
                        <div class="rts-hero__content--group" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                            <a href="{{route('pricing')}}" class="primary__btn white__bg">Get Started <i
                                    class="fa-regular fa-long-arrow-right"></i></a>
                            <a href="{{route('pricingPackage')}}" class="btn__zero plan__btn">Plans & Pricing <i
                                    class="fa-regular fa-long-arrow-right"></i></a>
                        </div>
                        <p data-sal="slide-down" data-sal-delay="600" data-sal-duration="800"><img src="{{asset('assets/images/icon/dollar.svg')}}" alt="">Starting from <span><span rt-currency-symbol>$</span><span rt-price>2.95</span></span> per month</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="rts-hero__images position-relative">
                        <div class="rts-hero-main">
                            <div class="image-main ">
                                <img class="main top-bottom2" src="{{asset('assets/images/banner/hosting-01.svg')}}" alt="">
                            </div>
                            <img class="hero-shape one" src="{{asset('assets/images/banner/hosting.svg')}}" alt="">
                        </div>
                        <div class="rts-hero__images--shape">
                            <div class="one top-bottom">
                                <img src="{{asset('assets/images/banner/left.svg')}}" alt="">
                            </div>
                            <div class="two bottom-top">
                                <img src="{{asset('assets/images/banner/left.svg')}}" alt="">
                            </div>
                            <div class="three top-bottom">
                                <img src="{{asset('assets/images/banner/top.svg')}}" alt="">
                            </div>
                            <div class="four bottom-top">
                                <img src="{{asset('assets/images/banner/right.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="rts-brand__wrapper">
                        <div class="rts-brand__wrapper--text">
                            ...
                            <div class="rts-brand__wrapper--text-review" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                                <div class="review">
                                    <div class="star">Excellent <img src="{{asset('assets/images/brand/review-star.svg')}}" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"><img src="{{asset('assets/images/brand/01.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"><img src="{{asset('assets/images/brand/02.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"><img src="{{asset('assets/images/brand/03.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"><img src="{{asset('assets/images/brand/04.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"><img src="{{asset('assets/images/brand/05.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"><img src="{{asset('assets/images/brand/06.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"> <img src="{{asset('assets/images/brand/07.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                                        <a href="#" aria-label="brand-link"><img src="{{asset('assets/images/brand/08.svg')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="rts-brand__slider--single">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="rts-hosting-type__single">
                                    ...
                                    <h6 class="price__start">Starting from <span class="mb-0" rt-currency-symbol>$</span> <span class="mb-0" rt-price>2.95</span>/month</h6>
                                    <a href="{{route('WordPressHosting')}}" class="primary__btn border__btn">See Plan <i
                                            class="fa-regular fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <!-- single package end -->
                            ...
                            <div class="swiper-slide">
                                <div class="rts-hosting-type__single">
                                    ...
                                    <a href="{{route('WordPressHosting')}}" class="title">Web Hosting</a>
                                    <p class="excerpt">Manage your WordPress sites easily and more freedom.</p>
                                    <h6 class="price__start">Starting from <span class="mb-0" rt-currency-symbol>$</span> <span class="mb-0" rt-price>2.95</span>/month</h6>
                                    <a href="{{route('WordPressHosting')}}" class="primary__btn border__btn">See Plan <i
                                            class="fa-regular fa-long-arrow-right"></i></a>
                            ...
                            <div class="swiper-slide">
                                <div class="rts-hosting-type__single">
                                    ...
                                    <p class="excerpt">Manage your WordPress sites easily and more freedom.</p>
                                    <h6 class="price__start">Starting from <span class="mb-0" rt-currency-symbol>$</span> <span class="mb-0" rt-price>2.95</span>/month</h6>
                                    <a href="{{route('vpsHosting')}}" class="primary__btn border__btn">See Plan <i
                                            class="fa-regular fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <!-- single package end -->
                            ...
                            <div class="swiper-slide">
                                <div class="rts-hosting-type__single">
                                    ...
                                    <p class="excerpt">Manage your WordPress sites easily and more freedom.</p>
                                    <h6 class="price__start">Starting from <span class="mb-0" rt-currency-symbol>$</span> <span class="mb-0" rt-price>2.95</span>/month</h6>
                                    <a href="{{route('sharedHosting')}}" class="primary__btn border__btn">See Plan 
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="rts-about__image">
                        <img src="{{asset('assets/images/about/about-big.png')}}" alt="">
                        <img src="{{asset('assets/images/about/about-shape-01.svg')}}" alt="" class="shape one right-left">
                        <img src="{{asset('assets/images/about/about-shape-02.svg')}}" alt="" class="shape two">
                    </div>
                </div>
                    ...
                    <div class="rts-about__content">
                        ...
                        <div class="rts-about__content--single" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                            <div class="image">
                                ...
                                <img src="{{asset('assets/images/about/01.svg')}}" alt="">
                            </div>
                        ...
                        <div class="rts-about__content--single" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                            <div class="image bg-2">
                                <img src="{{asset('assets/images/about/02.svg')}}" alt="">
                            </div>
                            <div class="description">
                ...
                <div class="col-12">
                    <div class="rts-domain-finder__content domain-finder-bg">
                        ...
                        <form action="https://hostie-whmcs.themewant.com/cart.php" class="domain-checker" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                            ...
                            <button type="submit" aria-label="register domain" name="domain_type">search domain</button>
                        </form>
                        <div class="compare">
                ...
                <div class="rts-service__wrapper">
                    <div class="rts-service__column">
                        ...
                        <div class="rts-service__single">
                            ...
                            <a href="{{route('sharedHosting')}}" class="rts-service__single--title">Shared Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('sharedHosting')}}" class="rts-service__single--btn">View Details <i
                        ...
                        <div class="rts-service__single">
                            <div class="rts-service__single--icon email__hosting">
                                <img src="{{asset('assets/images/service/email__hosting.svg')}}" alt="">
                            </div>
                            <a href="{{route('businessMail')}}" class="rts-service__single--title">Email Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('businessMail')}}" class="rts-service__single--btn">View Details <i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <!-- single service end -->
                    </div>
                    ...
                    <div class="rts-service__column">
                        ...
                        <div class="rts-service__single">
                            ...
                            <a href="{{route('WordPressHosting')}}" class="rts-service__single--title">WordPress Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('WordPressHosting')}}" class="rts-service__single--btn">View Details <i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <!-- single service end -->
                        <!-- single service -->
                        <div class="rts-service__single">
                            <div class="rts-service__single--icon dedicated__hosting">
                                <img src="{{asset('assets/images/service/dedicated__hosting.svg')}}" alt="">
                            </div>
                            <a href="{{route('dedicatedHosting')}}" class="rts-service__single--title">dedicated Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('dedicatedHosting')}}" class="rts-service__single--btn">View Details <i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <!-- single service end -->
                    ...
                    <div class="rts-service__column">
                        ...
                        <div class="rts-service__single">
                            <div class="rts-service__single--icon vps__hosting">
                                <img src="{{asset('assets/images/service/vps__hosting.svg')}}" alt="">
                            </div>
                            <a href="{{route('vpsHosting')}}" class="rts-service__single--title">VPS Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('vpsHosting')}}" class="rts-service__single--btn">View Details <i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <!-- single service end -->
                        <!-- single service -->
                        <div class="rts-service__single">
                            <div class="rts-service__single--icon eccomerce__hosting">
                                <img src="{{asset('assets/images/service/eccommerce__hosting.svg')}}" alt="">
                            </div>
                            <a href="{{route('WordPressHosting')}}" class="rts-service__single--title">eccommerce Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('WordPressHosting')}}" class="rts-service__single--btn">View Details <i
                    ...
                    <div class="rts-service__column">
                        ...
                        <div class="rts-service__single">
                            <div class="rts-service__single--icon reseller__hosting">
                                <img src="{{asset('assets/images/service/resseller__hosting.svg')}}" alt="">
                            </div>
                            <a href="{{route('resellerHosting')}}" class="rts-service__single--title">Reseller Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('resellerHosting')}}" class="rts-service__single--btn">View Details <i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <!-- single service end -->
                        <!-- single service -->
                        <div class="rts-service__single">
                            ...
                            <a href="{{route('cloudHosting')}}" class="rts-service__single--title">cloud Hosting</a>
                            <p class="rts-service__single--excerpt">
                                The most popular hosting plan available and comes at one of the most.
                            </p>
                            <a href="{{route('cloudHosting')}}" class="rts-service__single--btn">View Details <i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <!-- single service end -->
                    </div>
                ...
                <div class="col-12">
                    <div class="rts-data-center__location">
                        ...
                        <ul class="round-shape">
                            <li class="one">
                                <span class="tooltip1" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Canada" data-bs-custom-class="color-hostie" title="Canada">Canada</span>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="rts-whychoose__content">
                        ...
                        <div class="single" data-sal="slide-right" data-sal-delay="300" data-sal-duration="800">
                            <div class="single__image">
                                <img src="{{asset('assets/images/icon/speed.svg')}}" alt="">
                            </div>
                        ...
                        <div class="single" data-sal="slide-right" data-sal-delay="400" data-sal-duration="800">
                            <div class="single__image bg1">
                                <img src="{{asset('assets/images/icon/support.svg')}}" alt="">
                            </div>
                            <div class="single__content">
                        ...
                        <div class="single" data-sal="slide-right" data-sal-delay="500" data-sal-duration="800">
                            <div class="single__image">
                                <img src="{{asset('assets/images/icon/money-back.svg')}}" alt="">
                            </div>
                            <div class="single__content">
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="rts-whychoose__image">
                        <img src="{{asset('assets/images/whychoose.svg')}}" alt="">
                        <img src="{{asset('assets/images/paper-plane.svg')}}" alt="" class="shape one bottom-top">
                        <img src="{{asset('assets/images/wifi.svg')}}" alt="" class="shape two right-left">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <th class="package__item">
                                        <div class="package__item__info">
                                            ...
                                            <span class="start">Starting at <span class="mb-0" rt-currency-symbol>$</span><span class="mb-0" rt-price>3.75</span>/mo*</span>
                                            <form action="#">
                                                <select name="select" id="basic" class="price__select">
                                    ...
                                    <th class="package__item">
                                        ...
                                        <div class="package__item__info">
                                            ...
                                            <span class="start">Starting at <span class="mb-0" rt-currency-symbol>$</span><span class="mb-0" rt-price>3.75</span>/mo*</span>
                                            <form action="#">
                                                <select name="select" id="deluxe" class="price__select">
                                                    <option value="1">$3.75/mo</option>
                                                    <option value="1">$10.75/mo</option>
                                                </select>
                                                <button type="submit" aria-label="buy package" class="primary__btn primary__bg buy__now">By
                                    ...
                                    <th class="package__item">
                                        <div class="package__item__info">
                                            ...
                                            <span class="start">Starting at <span class="mb-0" rt-currency-symbol>$</span><span class="mb-0" rt-price>3.75</span>/mo*</span>
                                            <form action="#">
                                                <select name="select" id="ultra" class="price__select">
                                                    <option value="1">$3.75/mo</option>
                                                    <option value="1">$10.75/mo</option>
                                                </select>
                                                <button type="submit" aria-label="buy package" class="primary__btn primary__bg buy__now">By
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="rts-faq__first">
                        ...
                        <img data-sal="slide-down" data-sal-delay="500" data-sal-duration="800" src="{{asset('assets/images/faq/faq.svg')}}" alt="faq">
                        <div class="rts-faq__first--shape">
                            <div class="img"><img src="{{asset('assets/images/faq/faq__animated.svg')}}" alt=""></div>
                    ...
                    <div class="rts-cta__right">
                        <div class="cta-image">
                            <div class="cta-image__one">
                                <img src="{{asset('assets/images/cta/cta__hosting.svg')}}" alt="">
                            </div>
                            <div class="cta-image__two">
                                <img src="{{asset('assets/images/cta/cta__person.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
