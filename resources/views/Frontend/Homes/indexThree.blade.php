...
@section('content')
    ...
    <section class="rts-hero-three">
        ...
        <div class="hero-image-big">
            <img src="{{ asset ('assets/images/banner/banner-hero-3.png') }}" alt="">
        </div>
        <div class="banner-shape-area">
            <img class="one" src="{{ asset ('assets/images/banner/banner-shape-3_1.png') }}" alt="">
            <img class="two" src="{{ asset ('assets/images/banner/banner-shape-3_2.png') }}" alt="">
                ...
                <div class="row  g-5">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-wrapper">
                            <div class="icon">
                                <img src="{{ asset ('assets/images/service/cloud__hosting2.png') }}" alt="">
                            </div>
                            <div class="content">
                                <h4 class="title">Cloud Hosting</h4>
                                <p class="desc">WordPress Hosting gives speed performance with full features.</p>
                                <a href="{{route('cloudHosting')}}" class="view-more-btn">View More <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                            <div class="wrapper-shape">
                                <img src="{{ asset ('assets/images/service/service-bg-shape.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-wrapper">
                            <div class="icon">
                                <img src="{{ asset ('assets/images/service/web__hosting2.png') }}" alt="">
                            </div>
                            <div class="content">
                                <h4 class="title">Web Hosting</h4>
                                <p class="desc">WordPress Hosting gives speed performance with full features.</p>
                                <a href="{{route('WordPressHosting')}}" class="view-more-btn">View More <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                            <div class="wrapper-shape">
                                <img src="{{ asset ('assets/images/service/service-bg-shape.svg') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="service-wrapper">
                            <div class="icon">
                                <img src="{{ asset ('assets/images/service/reseller__hosting2.png') }}" alt="">
                            </div>
                            <div class="content">
                                <h4 class="title">Reseller Hosting</h4>
                                <p class="desc">WordPress Hosting gives speed performance with full features.</p>
                                <a href="{{route('resellerHosting')}}" class="view-more-btn">View More <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                            <div class="wrapper-shape">
                                <img src="{{ asset ('assets/images/service/service-bg-shape.svg') }}" alt="">
                            </div>
    ...
    <div class="rts-services-area area-3 service-bg pt--120 pb-120">
            ...
            <div class="section-inner">
                <div class="row  g-5">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                        <div class="service-wrapper">
                            <div class="icon">
                                <img src="{{ asset ('assets/images/service/dedicated.png') }}" alt="">
                            </div>
                            <div class="content">
                                <h4 class="title">Dedicated Hosting</h4>
                                <p class="desc">WordPress Hosting gives speed performance with full features.</p>
                                <a href="{{route('dedicatedHosting')}}" class="view-more-btn">View More <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                            <div class="wrapper-shape">
                                <img src="{{ asset ('assets/images/service/service-bg-shape.svg') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">
                        <div class="service-wrapper">
                            <div class="icon">
                                <img src="{{ asset ('assets/images/service/turbo.png') }}" alt="">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="800" data-sal-duration="800">
                        <div class="service-wrapper">
                            <div class="icon">
                                <img src="{{ asset ('assets/images/service/resell.png') }}" alt="">
                            </div>
                            <div class="content">
                                <h4 class="title">reseller Hosting</h4>
                                <p class="desc">WordPress Hosting gives speed performance with full features.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="900" data-sal-duration="800">
                        <div class="service-wrapper">
                            <div class="icon">
                                <img src="{{ asset ('assets/images/service/share.png') }}" alt="">
                            </div>
                            <div class="content">
                                <h4 class="title">Share Hosting</h4>
                                <p class="desc">WordPress Hosting gives speed performance with full features.</p>
                                <a href="{{route('sharedHosting')}}" class="view-more-btn">View More <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                            <div class="wrapper-shape">
                                <img src="{{ asset ('assets/images/service/service-bg-shape.svg') }}" alt="">
                            </div>
        ...
        <div class="service-shape-area">
            <img class="shape-one" src="{{ asset ('assets/images/service/service-bg-shape2.svg') }}" alt="">
            <img class="shape-two" src="{{ asset ('assets/images/service/service-bg-shape3.svg') }}" alt="">
        </div>
    </div>
    <!-- SERVICE AREA END-->
                    ...
                    <div class="row g-5 mt--60 inner-separator">
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--0 pt--50">
                            <div class="feature-wrapper text-center">
                                ...
                                <div class="icon">
                                    <img src="{{ asset ('assets/images/feature/feature-01.png') }}" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--0 pt--50">
                            <div class="feature-wrapper text-center">
                                <div class="overlay"></div>
                                <div class="icon">
                                    <img src="{{ asset ('assets/images/feature/feature-02.png') }}" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--0 pt--50">
                            <div class="feature-wrapper text-center">
                                <div class="overlay"></div>
                                <div class="icon">
                                    <img src="{{ asset ('assets/images/feature/feature-03.png') }}" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--0 pt--50">
                            <div class="feature-wrapper text-center">
                                <div class="overlay"></div>
                                <div class="icon">
                                    <img src="{{ asset ('assets/images/feature/feature-04.png') }}" alt="">
                                </div>
                                <div class="content">
    ...
    <div class="rts-hosting-feature-area pt--120 pb-120">
                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="left-side-image">
                            <img src="{{ asset ('assets/images/feature/feature-hero-01.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="right-side-content">
                            ...
                            <a href="{{route('pricing')}}" class="get-started-btn rts-btn" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">Get Started <i class="fa-light fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="feature-shape-area">
            <img class="one" src="{{ asset ('assets/images/feature/feature-rounded-shape.svg') }}" alt="">
        </div>
    </div>
    ...
    <section class="rts-testimonial area-3 section__padding">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="rts-testimonial__single">
                                        ...
                                        <div class="shape"><img src="{{ asset ('assets/images/testimonials/testimonial-wrapper-shape.svg') }}" alt=""></div>
                                    </div>
                                </div>
        ...
        <div class="testimonial-shape-area">
            <img class="one" src="{{ asset ('assets/images/testimonials/bg-shape-3.svg') }}" alt="">
            <img class="two" src="{{ asset ('assets/images/testimonials/bg-shape-4.svg') }}" alt="">
        </div>
    </section>
    <!-- TESTIMONIAL END -->
    ...
    <section class="rts-blog-area pt--120 section-style-radius-blog">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-10 mb-5">
                        <div class="blog-wrapper align-items-center wrapper-z-index">
                            <div class="image">
                                <img src="{{ asset ('assets/images/blog/blog-4.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                ...
                                <h3 class="blog-title"><a href="{{route('blogDetails')}}">Expanding Horizons: Announcing the
                                ...
                                <a href="{{route('blogDetails')}}" class="read-more-btn">Read More <i class="fa-light fa-angle-right"></i></a>
                            </div>
                            <div class="blog-shape">
                                <img src="{{ asset ('assets/images/blog/blog-shape.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-10">
                        <div class="blog-wrapper align-items-center">
                            <div class="image">
                                <img src="{{ asset ('assets/images/blog/blog-5.png') }}" alt="">
                            </div>
                            <div class="content">
                                <p class="blog-meta">
                                ...
                                <h3 class="blog-title"><a href="{{route('blogDetails')}}">Introducing Edge Page Caching, Argo
                            ...
                            <div class="blog-shape">
                                <img src="{{ asset ('assets/images/blog/blog-shape2.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="blog-shape-area">
            <img class="one" src="{{ asset ('assets/images/blog/line.svg') }}" alt="">
        </div>
        <!-- FAQ -->
            ...
            <div class="row">
                <div class="rts-cta__wrapper align-items-center">
                    ...
                    <div class="rts-cta__right">
                        <a href="{{route('signUp')}}" class="rts-btn">Sign Now <i class="fa-solid fa-chevron-right"></i></a>
                    </div>
                    <div class="cta-shape-area">
                        <img src="{{ asset ('assets/images/cta/cta__shape.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
