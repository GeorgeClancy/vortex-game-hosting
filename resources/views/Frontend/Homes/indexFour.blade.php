...
@section('content')
    ...
    <!-- HERO BANNER four -->
    <section class="rts-hero-four rts-hero__four" style="background-image: url({{ asset ('assets/images/banner/banner-hero-four.png') }});">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-8">
                    <div class="rts-service-four__tab--content tab__content open" id="wp">
                        <div class="tab__image">
                            <img src="{{ asset ('assets/images/service/service__tab.png') }}" alt="live">
                        </div>
                        <div class="tab__content--details">
                            ...
                            <a href="{{route('knowledgebase')}}" class="all-feature border__bottom">see all feature <i class="fa-regular fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="rts-service-four__tab--content tab__content" id="cloud">
                        ...
                        <div class="tab__content--details">
                            ...
                            <a href="{{route('knowledgebase')}}" class="all-feature">see all feature <i class="fa-regular fa-chevron-right"></i></a>
                        </div>
                    </div>
