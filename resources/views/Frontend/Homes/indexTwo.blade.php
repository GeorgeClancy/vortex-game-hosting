    ...
    <section class="rts-hero-two rts-hero-two__bg">
            ...
            <div class="row justify-content-md-center">
                <div class="col-xl-6 col-lg-7 col-md-9 order-md-2 order-lg-0">
                    <div class="rts-hero-two__content">
                        ...
                        <div class="rts-hero-two__content--btn" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                            <a href="{{route('pricing')}}" class="rts-btn btn__long secondary__bg secondary__color">get started
                                <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="{{route('pricingPackage')}}" class="rts-btn btn__long border__white white__color">start free
                                <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <div class="terms" data-aos="fade-down" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                            <img src="{{ asset ('assets/images/banner/cloud--lightning.svg') }}" alt="">
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-5 col-md-10">
                    <div class="rts-hero-two__images mobile-margin-top-100">
                        <img src="{{ asset ('assets/images/banner/two/hero__two__illustration.svg') }}" alt="">
                        <img class="shape-image one left-right-top-bottom" src="{{ asset ('assets/images/banner/two/hero__two__illustration-sm1.svg') }}" alt="">
                        <img class="shape-image two" src="{{ asset ('assets/images/banner/two/hero__two__illustration-sm2.svg') }}" alt="">
                        <img class="shape-image three" src="{{ asset ('assets/images/banner/two/hero__two__illustration-sm3.svg') }}" alt="">
                        <img class="shape-image four" src="{{ asset ('assets/images/banner/two/hero__two__illustration-sm4.svg') }}" alt="">
                        <img class="shape-image five" src="{{ asset ('assets/images/banner/two/hero__two__illustration-sm5.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="shape">
            <div class="shape__one">
                <img src="{{ asset ('assets/images/banner/banner__two__shape.svg') }}" alt="">
            </div>
        </div>
    </section>
    <!-- HERO BANNER ONE END -->
                    ...
                    <div class="rts-ds-two__wrapper">
                        ...
                        <div class="rts-ds-two__domainlist">
                            <div class="single-list">
                                ...
                                <span class="price">only <span rt-currency-symbol>$</span> <span rt-price>8.19</span> </span>
                            </div>
                            <div class="single-list">
                                <div class="name">.net</div>
                                <span class="price">only <span rt-currency-symbol>$</span> <span rt-price>10.19</span></span>
                            </div>
                            <div class="single-list">
                            ...
                            <div class="single-list">
                                ...
                                <span class="price">only <span rt-currency-symbol>$</span> <span rt-price>12.19</span></span>
                            </div>
                            <div class="single-list">
                                <div class="name">.info</div>
                                <span class="price">only <span rt-currency-symbol>$</span> <span rt-price>2.19</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="rts-section section-style-two">
                        ...
                        <div class="rts-section-button">
                            <a href="{{route('pricing')}}" class="rts-btn rts-btn-secondary">Learn More</a>
                        </div>
            ...
            <div class="row gy-30">
                <div class="col-lg-8 col-xl-6 col-md-8">
                    <div class="service-two">
                        <div class="service-two__content">
                            ...
                            <a href="{{route('cloudHosting')}}" class="primary__btn btn__two">Learn More</a>
                        </div>
                    ...
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            <div class="service-icon">
                                <img src="{{ asset ('assets/images/service/two/vps.svg') }}" height="45" width="52" alt="">
                            </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            <div class="service-icon">
                                <img src="{{ asset ('assets/images/service/two/dedicated.svg') }}" height="45" width="52" alt="">
                            </div>
                            <a href="{{route('dedicatedHosting')}}" class="service-title">Dedicated Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="{{route('dedicatedHosting')}}" class="service-btn"><i
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            <div class="service-icon">
                                <img src="{{ asset ('assets/images/service/two/email.svg') }}" height="45" width="52" alt="">
                            </div>
                            <a href="{{route('businessMail')}}" class="service-title">Email Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="{{route('businessMail')}}" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            <div class="service-icon">
                                <img src="{{ asset ('assets/images/service/two/ecommerce.svg') }}" height="45" width="52" alt="">
                            </div>
                            <a href="{{route('WordPressHosting')}}" class="service-title">Eccommerce Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="{{route('WordPressHosting')}}" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            <div class="service-icon">
                                <img src="{{ asset ('assets/images/service/two/cloud.svg') }}" height="45" width="52" alt="">
                            </div>
                            <a href="{{route('cloudHosting')}}" class="service-title">Cloud Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="{{route('cloudHosting')}}" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xl-3 col-md-4 col-sm-6">
                    <div class="service-two-small">
                        <div class="service-two-small__content">
                            <div class="service-icon">
                                <img src="{{ asset ('assets/images/service/two/cloud-2.svg') }}" height="45" width="52" alt="">
                            </div>
                            <a href="{{route('resellerHosting')}}" class="service-title">Reseller Hosting</a>
                            <p class="description">WordPress Hosting gives you speed performance with full of features.
                            </p>
                            <a href="{{route('resellerHosting')}}" class="service-btn"><i
                                    class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-5">
                    <div class="rts-pricing-plan__tab">
                        ...
                        <div class="discount">
                            <span class="line">
                                <img src="{{ asset ('assets/images/pricing/offer__vactor.svg') }}" height="20" width="85" alt=""></span>
                            <p>20% save</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>12.36</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow active">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>99.36</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>55.36</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>144.36</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow active">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>1000.36</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-plan has-box-shadow">
                            <div class="single-plan__content">
                                ...
                                <button class="buy__plan btn__two">
                                    Price: <span rt-currency-symbol>$</span><span rt-price>448.36</span>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="rts-cta-two__wrapper">
                    ...
                    <div class="cta-btn">
                        <a href="{{route('contact')}}" class="contact__us rts-btn rts-btn-secondary">contact us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center justify-content-sm-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-10 col-sm-10 mb-5 mb-lg-0">
                    <div class="rts-hosting-feature__image" data-sal="slide-left" data-sal-delay="600" data-sal-duration="800">
                        <img src="{{ asset ('assets/images/hosting/hosting__feature.svg') }}" alt="hosting feature image">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="rts-testimonial-two__single">
                                    <div class="quote"><img src="{{ asset ('assets/images/icon/quote__white.svg') }}" alt=""></div>
            ...
            <div class="row g-40 justify-content-sm-center">
                <div class="col-lg-6 col-md-10 col-sm-10">
                    <div class="rts-hosting-feature-two__image">
                        <img src="{{ asset ('assets/images/hosting/hosting__feature__two.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1 col-md-10 col-sm-10">
                    <div class="rts-hosting-feature-two__content">
                        ...
                        <a href="{{route('pricing')}}" class="rts-btn rts-btn-secondary">get started</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cta__button">
                        <p>Looking for a Hosting solution?</p><a href="{{route('contact')}}" class="light__cta">Contac Us</a>
                    </div>
                </div>
            </div>
