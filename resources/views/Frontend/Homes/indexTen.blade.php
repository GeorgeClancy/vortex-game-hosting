...
@section('title', 'Index Ten')
@section('content')
    <!-- HEADER AREA -->
        @include('Frontend.Includes.Headers.headerSeven')
    <!-- HEADER AREA END -->

    <!-- HERO BANNER four -->
    <section class="rts-hero-four rts-hero__four mern__hosting" style="background-image: url({{ asset ('assets/images/banner/banner__ten.jpg') }});">
        <div class="container">
                ...
                <div class="col-lg-8 col-xl-6 col-md-10">
                    <div class="rts-hero-four__content" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                        ...
                        <div class="banner-buttons" data-sal="slide-down" data-sal-delay="800" data-sal-duration="800">
                            <a href="{{route('pricing')}}" class="rts-btn btn__long secondary__bg secondary__color">get started <i class="fa-solid fa-chevron-right"></i></a>
                            <a href="{{route('contact')}}" class="rts-btn btn__long border__white white__color">contact us <i class="fa-solid fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="rts-section section-style-two">
                    ...
                    <div class="rts-section-description w-550">
                        ...
                        <a href="{{route('pricing')}}">View all feature <i class="fa-solid fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- feature lsit -->
            <div class="row g-30">
                <div class="col-lg-3 col-sm-6 sal-animate" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                    <div class="feature__single">
                        ...
                        <a href="{{route('faq')}}" class="feature__single--title">Passion for Privacy</a>
                        <p class="feature__single--description">We believe in everyone's right to
                            privacy &amp; we back policy
                        </p>
                        <div class="feature__single--btn">
                            <a href="{{route('faq')}}" class="round__btn"><i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 sal-animate" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                    <div class="feature__single">
                        ...
                        <a href="{{route('faq')}}" class="feature__single--title">Money-Back Guaranteed</a>
                        <p class="feature__single--description">We believe in everyone's right to
                            privacy &amp; we back policy
                        </p>
                        <div class="feature__single--btn">
                ...
                <div class="col-lg-3 col-sm-6 sal-animate" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                    <div class="feature__single">
                        ...
                        <a href="{{route('faq')}}" class="feature__single--title">super easy to use</a>
                ...
                <div class="col-lg-3 col-sm-6 sal-animate" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">
                    <div class="feature__single">
                        ...
                        <a href="{{route('faq')}}" class="feature__single--title">First &amp; Reliable</a>
                        <p class="feature__single--description">We believe in everyone's right to
                            privacy &amp; we back policy
                        </p>
                        <div class="feature__single--btn">
