            ...
            <div class="banner-slider-active">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="rts-hero-banner banner-six" style="background-image: url({{ asset ('assets/images/banner/banner__six.png') }});">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-md-2 col-xl-6 offset-xxl-0 col-md-10">
                                        <div class="banner-content">
                                            <div class="banner-top">
                                                <div class="icon"><img src="{{ asset ('assets/images/banner/title-shape.svg') }}" alt=""></div>
                                                Meet Hostie
                                            </div>
                                            ...
                                            <div class="banner-btn">
                                                <a href="{{route('pricing')}}" class="rts-btn btn__long white__bg secondary__color">Plan & Pricing <i class="fa-regular fa-chevron-right"></i></a>
                                                <a href="{{route('contact')}}" class="rts-btn btn__long border__white white__color">Get a Quote <i class="fa-regular fa-chevron-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rts-hero-banner banner-six" style="background-image: url({{ asset ('assets/images/banner/banner__six-2.png') }});">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-md-2 col-xl-6 offset-xxl-0 col-md-10">
                                        <div class="banner-content">
                    ...
                    <div class="swiper-slide">
                        <div class="rts-hero-banner banner-six" style="background-image: url({{ asset ('assets/images/banner/banner__six-3.png') }});">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-md-2 col-xl-6 offset-xxl-0 col-md-10">
                                        <div class="banner-content">
    ...
    <section class="rts-feature-six section__padding">
        <div class="container">
            ...
            <div class="row gy-30">
                ...
                <div class="plan__btn">
                    <a href="{{route('pricing')}}">See Our Hosting Plan <i class="fa-regular fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-40">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="rts-hosting-feature-two__content">
                        ...
                        <a href="{{route('pricing')}}" class="rts-btn rts-btn-secondary" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">get started</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-7 col-md-8">
                    <div class="rts-service-four__tab--content tab__content open" id="wp">
                        <div class="tab__image">
                            <img src="{{ asset ('assets/images/service/service__tab.png') }}" height="700" width="757" alt="live">
                        </div>
                        <div class="tab__content--details">
                            ...
                            <a href="{{route('faq')}}" class="all-feature border__bottom">see all feature <i class="fa-regular fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="rts-service-four__tab--content tab__content" id="cloud">
                        <div class="tab__image">
                            <img src="{{ asset ('assets/images/service/service__tab.png') }}" width="757" height="500" alt="live">
                        </div>
                        <div class="tab__content--details">
                            ...
                            <a href="{{route('faq')}}" class="all-feature">see all feature <i class="fa-regular fa-chevron-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="rts-service-four__tab--content tab__content" id="dedicated">
                        <div class="tab__image">
                            <img src="{{ asset ('assets/images/service/service__tab-2.png') }}" width="757" height="500" alt="live">
                        </div>
                        <div class="tab__content--details">
                    ...
                    <div class="col-lg-6" data-sal="slide-right" data-sal-delay="400" data-sal-duration="800">
                        <div class="blog-wrapper">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title animated fadeIn"><a href="{{route('blogDetails')}}">Expanding Horizons: Announcing the
                    ...
                    <div class="col-lg-6" data-sal="slide-left" data-sal-delay="500" data-sal-duration="800">
                        <div class="blog-wrapper">
                            ...
                            <div class="content">
                                ...
                                <h3 class="blog-title animated fadeIn"><a href="{{route('blogDetails')}}">Introducing Edge Page Caching, Argo
