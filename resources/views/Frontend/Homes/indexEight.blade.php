...
@section('title', 'Index Eight')
@section('content')
    <!-- HEADER AREA -->
        @include('Frontend.Includes.Headers.headerSix')
    <!-- HEADER AREA END -->

    <!-- HERO BANNER ONE -->
    <section class="rts-hero cloud-banner">
        <div class="container">
            <div class="row align-items-end position-relative">
                <div class="col-lg-7">
                    <div class="rts-hero__content w-570">
                        <h6 data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                            <img src="{{asset('assets/images/icon/cloud-3.svg') }}" alt="">
                        ...
                        <p class="rts-hero__content--description mt--10">
                            "Discover our cutting-edge cloud hosting solutions designed to elevate your online presence. With lightning-fast performance, unparalleled reliability, and scalable resources.
                        </p>
                        <div class="hosting-feature sal-animate" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                            <div class="hosting-feature__single">
                                <div class="icon-image">
                                    <img src="{{asset('assets/images/icon/white-lavel.svg') }}" alt="">
                                </div>
    ...
    <!-- PRICING PLAN START -->
    <div class="rts-pricing-plan section__padding cloud__pricing__bg">
        <div class="container">
            <div class="row justify-content-center">
    ...
    <div class="rts-support-feature section__padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-xl-6 col-md-10">
                    <div class="support-feature-image">
                        <img src="{{asset('assets/images/feature/support__feature__two.jpg') }}" width="645" height="477" alt="">
                    </div>
                </div>
    ...
    <div class="rts-client-feedback cloud__feedback">
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    <div class="feadback-card__single__rating">
    ...
    <!-- SUPPORT FEATURE -->
    <div class="rts-support-feature section__padding cloud__feature">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-xl-6 col-md-10">
                    <div class="support-feature-image">
                        <img src="{{asset('assets/images/feature/feature__image__three.png') }}" alt="">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-7 col-md-10">
                    <div class="support-feature__content">
                        <h2 class="title mw-100" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                            Why Choose Cloud
                            Hosting with Hostie
                        </h2>
                        <p class="description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
    ...
    <!-- FOOTER AREA -->
    @include('Frontend.Includes.Footers.footerSix')
    <!-- FOOTER AREA END -->
@endsection