            ...
            <div class="row">
                <div class="rts-ht__wrapper">
                    <div class="rts-ht__email">
                        <a href="mailto:info@hostie.com"><img src="{{asset('assets/images/icon/email.svg')}}" alt="" class="icon">contact@hostie.com</a>
                    </div>
                    <div class="rts-ht__promo">
                        <p><img class="icon" src="{{asset('assets/images/icon/tag--group.svg')}}" alt=""> Hosting Flash Sale: Starting at <strong>$2.59/mo</strong> for a limited time</p>
                    </div>
                    <div class="rts-ht__links">
                        <div class="live-chat-has-dropdown">
                            <a href="#" class="live__chat"><img src="{{asset('assets/images/icon/forum.svg')}}" alt="" class="icon">Live Chat</a>
                        </div>
                        <div class="login-btn-has-dropdown">
                            <a href="#" class="login__link"><img src="{{asset('assets/images/icon/person.svg')}}" alt="" class="icon">Login</a>
        ...
        <div class="row">
            <div class="rts-header__wrapper">
                ...
                <div class="rts-header__right">
                    @include('Frontend.Includes.Currency.currency')
